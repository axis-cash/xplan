            ...
            <div>
                <div className="layout-top">
                    <NavBar
                        ...
                        mode="light"
                        leftContent={<span style={{color:"#ffffff"}}>{lang.e().button.cancel}</span>}
                        onLeftClick={()=>{
                            url.goBack();
                        }}
                        rightContent={<span style={{color:"#ffffff"}} onClick={()=>{this.submit()}}>{lang.e().button.save}</span>}
                    >
                        {lang.e().page.addressBook.detail}
                    </NavBar>
                </div>
                <div style={{marginTop:"45px"}}>
                    <div style={{background:"#1A1A1B",padding:"15px"}}>
                        <WhiteSpace size="lg"/>
                        <WhiteSpace size="lg"/>
                    ...
                    }} style={{backgroundColor:"#CAAC7B"}}><span style={{color:"#DFDFDF"}}>{lang.e().button.deleteAddress}</span></Button>
                </div>
            </div>
