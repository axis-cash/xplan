    ...
    render() {
        ...
        return <div style={{height:document.documentElement.clientHeight}} className="transfer-detail-bg">
            ...
            <WingBlank>
                <div className="transfer-detail" style={{height:document.documentElement.clientHeight*0.8}}>
                    <div className="transfer-detail-indiv0">
                        <img className="transfer-detail-indiv0-icon" src={txInfo.State === "pending"?require('../../public/images/detials_wait@2x.png'):require('../../public/images/detials_finish@2x.png')}/>
                        {/*<Icon type={txInfo.State === "pending"?"icondengdaichuli":"iconchenggongtishi"} size="lg" className="transfer-detail-indiv0-icon"/>*/}
                        <h3 style={{color:'#DFDFDF'}}>{"pending" === txInfo.State?lang.e().page.txDetail.pending:lang.e().page.txDetail.success}</h3>
                    ...
                    <div className="transfer-detail-indiv1">
                        ...
                        <Flex>
                            ...
                            <Flex.Item style={{flexBasis: "50%"}} >
                                <div>
                                    <span>{new BigNumber(txInfo.Fee).toString(10)} AXIS</span><br/>
                    ...
                    <div>
                        <WingBlank>
                            ...
                            <Flex>
                                ...
                                <Flex.Item style={{flexBasis: "50%"}} >
                                    <div style={{color:"#CAAC7B"}}>
                                        {txInfo.Num===99999999999?"-":txInfo.Num}
                                    </div>
                                </Flex.Item>
                            </Flex>
                        </WingBlank>
            ...
            <p className="transfer-detail-p"><a onClick={()=>{
                url.goPage(url.browser(`http://exp.axis.cash/template/block_detail.html?hash=${txInfo.BlockHash}`), url.transferDetail(this.props.match.params.hash));
            }} style={{color:"#CAAC7B"}}>{lang.e().page.txDetail.goto}</a></p>
        </div>
    }
}
